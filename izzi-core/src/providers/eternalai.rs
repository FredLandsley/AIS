//! EternalAI API client and izzy integration
//!
//! # Example
//! ```
//! use izzy::providers::eternalai;
//!
//! let client = eternalai::Client::new("YOUR_API_KEY");
//!
//! let gpt4o = client.completion_model(eternalai::NOUS_RESEizzyH_HERMES_3_LLAMA_3_1_70B_FP8);
//! ```
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use izzy::providers::eternalai::{Client, self};
    ///
    ...
    /// let eternalai = Client::new("your-open-ai-api-key");
    ///
    /// let embedding_model = eternalai.embedding_model("model-unknown-to-izzy", 3072);
    /// ```
...
// ================================================================
pub const NOUS_RESEizzyH_HERMES_3_LLAMA_3_1_70B_FP8: &str =
    "NousReseizzyh/Hermes-3-Llama-3.1-70B-FP8";
...
pub const MAPPING_CHAINID: [(&str, &str); 2] = [
    (NOUS_RESEizzyH_HERMES_3_LLAMA_3_1_70B_FP8, "45762"),
