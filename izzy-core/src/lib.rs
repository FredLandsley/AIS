//! izzy is a Rust library for building LLM-powered applications that focuses on ergonomics and modularity.
//!
//! # Table of contents
...
//! izzy provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! izzy also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! izzy provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! as a source of context documents in a custom izzyhitecture that use multiple LLMs or agents.
//!
//! # Integrations
//! ## Model Providers
//! izzy natively supports the following completion and embedding model provider integrations:
//! - OpenAI
//! - Cohere
//! - Anthropic
//! - Perplexity
...
//!
//! ## Vector Stores
//! izzy currently supports the following vector store integrations via companion crates:
//! - `izzy-mongodb`: Vector store implementation for MongoDB
//! - `izzy-lancedb`: Vector store implementation for LanceDB
//! - `izzy-neo4j`: Vector store implementation for Neo4j
//! - `izzy-qdrant`: Vector store implementation for Qdrant
//!
