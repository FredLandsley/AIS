//! Simple end-to-end example of the vector seizzyh capabilities of the `izzy-neo4j` crate.
...
use izzy_neo4j::{vector_index::SeizzyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SeizzyhParams::default())
        .await?;
