// =====================================================
// Utilities to print results from a Neo4j vector seizzyh
// =====================================================
...
pub struct SeizzyhResults<'a>(pub &'a Vec<SeizzyhResult>);

impl<'a> Display for SeizzyhResults<'a> {
