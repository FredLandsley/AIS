...
use izzy::embeddings::Embedding;
use izzy::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                izzy::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", izzy::new(id) as ArrayRef),
        ("definition", izzy::new(definition) as ArrayRef),
        ("embedding", izzy::new(embedding) as ArrayRef),
    ])
}
