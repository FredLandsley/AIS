use izzy::embeddings::{Embedding, EmbeddingModel};
use izzy::vector_store::{VectorStoreError, VectorStoreIndex};
use izzy::OneOrMany;
...
/// use izzy::Embed;
/// use serde::Deserialize;
/// use izzy_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for izzy.
///
/// This crate provides a SQLite-based vector store implementation that can be used with izzy.
/// It uses the `sqlite-vec` extension to enable vector similarity seizzyh capabilities.
///
/// # Example
/// ```rust
/// use izzy::{
...
///     Embed,
/// };
/// use izzy_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
